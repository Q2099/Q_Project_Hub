document.addEventListener("DOMContentLoaded", function() {
  function updateSummary() {
    ...
    // Ensure comma separation for both checkboxes
    const options = [];
    if (directFlights?.checked) options.push("Direct Flights Only");
    if (bagOnlyFares?.checked) options.push("Hand Luggage Only");
    const flightOptionsText = options.join(", ");
    ...
    const summaryParts = [
      ...
      bagText
       ...
       // Comma-separated plain text output
